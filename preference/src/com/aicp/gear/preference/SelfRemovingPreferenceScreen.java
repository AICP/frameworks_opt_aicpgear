...
/**
 * A PreferenceScreen which can automatically remove itself from the hierarchy
 * based on constraints set in XML.
 */
public class SelfRemovingPreferenceScreen extends PreferenceScreen {

    private final ConstraintsHelper mConstraints;

    public SelfRemovingPreferenceScreen(Context context, AttributeSet attrs,
                                  int defStyle, int defStyleRes) {
        super(context, attrs, defStyle, defStyleRes);
        mConstraints = new ConstraintsHelper(context, attrs, this);
    }

    public SelfRemovingPreferenceScreen(Context context, AttributeSet attrs, int defStyle) {
    ...
    public SelfRemovingPreferenceScreen(Context context) {
        this(context, null);
    }
