...
public class CustomSliderPreference extends SliderPreference {
    ...
    private void readLegacyAttrs(Context c, AttributeSet attrs) {
        ...
        final TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.SliderPreference);
        try {
            mShowSign = a.getBoolean(R.styleable.SliderPreference_showSign, false);
            final String units = a.getString(R.styleable.SliderPreference_units);
            if (units != null) mUnits = units;

            final boolean continuous = a.getBoolean(
                    R.styleable.SliderPreference_continuousUpdates, false);
            ...
            if (step <= 0 || span == 0) {
                setSliderIncrement(1); // Always use discrete steps for SliderPreference
            } else if ((span % step) != 0) {
    ...
    public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
        ...
        if (minusFrame != null && minusIcon != null) {
            ...
            minusIcon.setImageResource(R.drawable.ic_slider_minus);
        ...
        if (plusFrame != null && plusIcon != null) {
            ...
            plusIcon.setImageResource(R.drawable.ic_slider_plus);
    ...
    private void attachResetIcon(TextView tv) {
        ...
        final Drawable icon = ResourcesCompat.getDrawable(
                tv.getResources(), R.drawable.ic_slider_reset, tv.getContext().getTheme());
        if (icon == null) return;
